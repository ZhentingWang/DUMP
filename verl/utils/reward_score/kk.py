...
def compute_score(solution_str: str, 
    ...
    Args:
        ...
        ground_truth: Dictionary containing ground truth data, string with solution,
                     or JSON string representation of a dictionary
    ...
    # Parse ground truth data - handle different formats
    if isinstance(ground_truth, dict):
        ...
        try:
            ...
            if isinstance(ground_truth_dict, dict) and 'solution_text_format' in ground_truth_dict:
                solution_text = ground_truth_dict['solution_text_format']
            else:
                # Direct solution text string
                solution_text = ground_truth
        except json.JSONDecodeError:
            # Not a valid JSON, treat as direct solution text
            solution_text = ground_truth
    else:
        print(f"[Warning] Unexpected ground_truth type: {type(ground_truth)}")
        solution_text = str(ground_truth)
