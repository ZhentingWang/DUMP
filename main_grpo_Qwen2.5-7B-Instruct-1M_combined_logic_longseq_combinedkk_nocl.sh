...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='Qwen2.5-7B-Instruct-1M_combined_logic_longseq_balance400_combinedkk_nocl_1' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.default_local_dir=./local_save_dir/GRPO_combined_logic_Qwen2.5-7B-Instruct-1M_longseq_balance400_combinedkk_nocl_1 \
    ...
    trainer.total_epochs=2 $@ 2>&1 | tee standardtraining_GRPO_combined_logic_Qwen2.5-7B-Instruct-1M_longseqcombined_logic_dataset_v0_balance400_combinedkk_nocl_1.log
